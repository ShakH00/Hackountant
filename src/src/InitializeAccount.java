...
public class InitializeAccount extends JFrame {
    private JPanel contentPane;
    private BankAccount initializeChequing;
    protected  JTextField txtField;
    private JLabel errorTxt;

    public InitializeAccount(BankAccount account){
        initializeChequing = account;
        setTitle("Initialize Chequing Account");
        ...
        JButton initializeBtn = new JButton("Confirm");
        initializeBtn.addMouseListener(new MouseAdapter() {
            @Override
    ...
    public void firstDeposit(){
        ...
        try{
            ...
            initializeChequing.deposit(amt, "Initialized balance");
            dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
